    ...
    <div className="mx-auto max-w-4xl px-4 py-12">
      <div className="text-center mb-12">
        <h1 className="text-3xl font-bold text-gray-900 dark:text-gray-100 mb-3">
          Upgrade to <span className="text-amber-500 dark:text-amber-400">Pro</span>
        </h1>
      ...
      {status?.isPro ? (
        <div className="rounded-2xl border-2 border-amber-200 bg-amber-50 dark:bg-amber-950/40 p-8 text-center mb-12">
          <FiZap className="h-12 w-12 text-amber-500 dark:text-amber-400 mx-auto mb-4" />
          <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-2">You're a Pro member!</h2>
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-2 mb-12">
          <div className="rounded-2xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 p-8 relative">
            <h3 className="text-xl font-bold text-gray-900 dark:text-gray-100 mb-1">Monthly</h3>
            ...
            <button
              ...
              className="w-full rounded-lg border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-900 px-4 py-3 text-sm font-medium text-gray-900 dark:text-gray-100 hover:bg-gray-50 dark:hover:bg-gray-800 disabled:opacity-50"
            >
              {checkoutLoading === 'monthly' ? 'Loading...' : 'Get Pro Monthly'}
            </button>
          </div>

          <div className="rounded-2xl border-2 border-amber-400 bg-white dark:bg-gray-900 p-8 relative">
            <span className="absolute -top-3 right-4 rounded-full bg-amber-500 px-3 py-1 text-xs font-semibold text-white">
              Save 35%
            </span>
            <h3 className="text-xl font-bold text-gray-900 dark:text-gray-100 mb-1">Annual</h3>
            <p className="text-gray-500 dark:text-gray-400 text-sm mb-4">Billed annually</p>
            <div className="mb-6">
              <span className="text-4xl font-bold text-gray-900 dark:text-gray-100">$39</span>
      ...
      <div className="mb-12">
        <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100 text-center mb-8">Pro Benefits</h2>
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
          {proBenefits.map((benefit) => (
            <div key={benefit.title} className="flex gap-4 rounded-xl bg-gray-50 dark:bg-gray-900 p-5">
              ...
              <div>
                <h3 className="font-semibold text-gray-900 dark:text-gray-100">{benefit.title}</h3>
      ...
      <div className="rounded-2xl bg-gray-50 dark:bg-gray-900 p-8 text-center">
