  ...
  if (error || !connection) {
    return (
      <div className="mx-auto max-w-md px-4 py-16 text-center">
        <h1 className="text-xl font-semibold text-gray-900">Connection not found</h1>
        <p className="mt-2 text-sm text-gray-600">{error || 'This connection does not exist.'}</p>
    ...
    <div className="mx-auto max-w-2xl px-4 py-10 sm:px-6 lg:px-8">
      <div className="rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
        <div className="flex items-center justify-between">
          <h1 className="text-lg font-bold text-gray-900">Connection Details</h1>
        ...
        {skill && (
          <div className="mt-4 rounded-md bg-gray-50 p-3">
            <p className="text-sm font-medium text-gray-700">Skill: {skill.skillName}</p>
        ...
        <div className="mt-4">
          ...
          <p className="mt-1 text-sm text-gray-600">{connection.message}</p>
        </div>
        ...
        {connection.responseMessage && (
          <div className="mt-3">
            ...
            <p className="mt-1 text-sm text-gray-600">{connection.responseMessage}</p>
          </div>
        )}
