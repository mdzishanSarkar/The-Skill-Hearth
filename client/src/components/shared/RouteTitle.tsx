...
const TITLE_ROUTES: ReadonlyArray<{ pattern: RegExp; title: string }> = [
  ...
  { pattern: /^\/radar\/?$/, title: 'Skill radar' },
  { pattern: /^\/demand\/?$/, title: 'Skill demand' },
  { pattern: /^\/ask\/?$/, title: 'Ask the Hearth' },
  ...
  { pattern: /^\/challenges\/.+/, title: 'Challenge details' },
  ...
  { pattern: /^\/feed\/?$/, title: 'Hearth feed' },
  { pattern: /^\/friends\/?$/, title: 'Friends' },
  { pattern: /^\/gamification\/?$/, title: 'Achievements' },
  { pattern: /^\/swap-ready-matches\/?$/, title: 'Swap-ready matches' },
  { pattern: /^\/swaps\/?$/, title: 'My swaps' },
  ...
  { pattern: /^\/learner-board\/.+/, title: 'Learner request' },
  ...
  { pattern: /^\/journal\/?$/, title: 'Journal' },
  { pattern: /^\/journal\/.+/, title: 'Journal entry' },
  { pattern: /^\/impact\/?$/, title: 'Your impact' },
